\section{Les liaisons mécaniques}
...
Hélicoïdale & \begin{minipage}{0.2\linewidth}
...
\ifdef{\public}{\includegraphics[width=40pt]{img/pivot1} & \includegraphics[width=40pt]{img/pivot2} & \includegraphics[width=40pt]{img/pivot3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{\includegraphics[width=40pt]{img/gliss1} & \includegraphics[width=40pt]{img/gliss2} & \includegraphics[width=40pt]{img/gliss3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{\includegraphics[width=40pt]{img/heli1} & \includegraphics[width=40pt]{img/heli2} & \includegraphics[width=40pt]{img/heli3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{\includegraphics[width=40pt]{img/pivgliss1} & \includegraphics[width=40pt]{img/pivgliss2} & \includegraphics[width=40pt]{img/pivgliss3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{ & \includegraphics[width=40pt]{img/rot1} & }{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{ & \includegraphics[width=40pt]{img/sphdoi1} & }{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{\includegraphics[width=40pt]{img/plan1} & \includegraphics[width=40pt]{img/plan2} & \includegraphics[width=40pt]{img/plan3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{\includegraphics[width=40pt]{img/linan1} & \includegraphics[width=40pt]{img/linan2} & \includegraphics[width=40pt]{img/linan3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{\includegraphics[width=40pt]{img/linrec1} & \includegraphics[width=40pt]{img/linrec2} & \includegraphics[width=40pt]{img/linrec3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{tabular}{c c c}
Vue plane de face & Vue plane de côté & Perspective \\
\ifdef{\public}{\includegraphics[width=40pt]{img/pon1} & \includegraphics[width=40pt]{img/pon2} & \includegraphics[width=40pt]{img/pon3}}{}
\end{tabular}
\end{minipage}
}}
...
\begin{center}
\ifdef{\public}{$\left\{V_{S/R}\right\}_{P}=\left\{ \begin{array}{c} \overrightarrow{\Omega_{S/R}} \\ \overrightarrow{V_{P\in {S/R}}} \end{array}\right\}_{P}=\left\{ \begin{array}{cc} \omega_x & V_x \\ \omega_y & V_y \\ \omega_z & V_z \end{array}\right\}_{P}$}{\vspace{30pt}}
\end{center}
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} \omega_x & 0 \\ 0 & 0 \\ 0 & 0 \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$}{ &  & \\ &  & \\ &  &} \\
\hline
Liaison glissière & Torseur cinématique & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & V_x \\ 0 & 0 \\ 0 & 0 \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$}{ &  & \\ &  & \\ &  &} \\
\hline
Liaison hélicoïdale & Torseur cinématique & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} \omega_x & V_x \\ 0 & 0 \\ 0 & 0 \end{array}\right\}_{O}$  & \begin{tabular}{l} 1 axe $\overrightarrow{x}$ \\ $V_x=\frac{p.\omega_x}{2\pi}$ \end{tabular} }{ &  & \\ &  & \\ &  &} \\
\hline
\end{tabular}
\end{center}
}}
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} \omega_x & V_x \\ 0 & 0 \\ 0 & 0 \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$ }{ &  & \\ &  & \\ &  &} \\
\hline
Liaison sphérique à doigts & Torseur cinématique & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} \omega_x & 0 \\ \omega_y & 0 \\ 0 & 0 \end{array}\right\}_{O}$  & 2 axes, $\overrightarrow{x},\overrightarrow{y}$  }{ &  & \\ &  & \\ &  &} \\
\hline
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & V_x \\ 0 & V_y \\ \omega_z & 0 \end{array}\right\}_{O}$  & \begin{tabular}{l} 1 axe $\overrightarrow{z}$ \\ normale au plan \end{tabular} }{ &  & \\ &  & \\ &  &}  \\
\hline
\end{tabular}
\end{center}
}}
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} \omega_x & V_x \\ \omega_y & 0 \\ \omega_z & 0 \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$ }{ &  & \\ &  & \\ &  &}\\
\hline
Liaison linéaire rectiligne & Torseur cinématique & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} \omega_x & V_x \\ 0 & V_y \\ \omega_z & 0 \end{array}\right\}_{O}$  & \begin{tabular}{l} 2 axes $\overrightarrow{x}$, $\overrightarrow{z}$ \\ direction de la ligne $\overrightarrow{x}$ \\ normale au plan $\overrightarrow{z}$ \end{tabular} }{ &  & \\ &  & \\ &  &} \\
\hline
Liaison ponctuelle & Torseur cinématique & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} \omega_x & V_x \\ \omega_y & V_y \\ \omega_z & 0 \end{array}\right\}_{O}$  & \begin{tabular}{l} 1 axe $\overrightarrow{z}$ \\ normale au plan \end{tabular} }{ &  & \\ &  & \\ &  &} \\
\hline
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} X & 0 \\ Y & M \\ Z & N \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$}{ &  & \\ &  & \\ &  &} \\
\hline
Liaison glissière & Torseur d'actions transmissibles & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & L \\ Y & M \\ Z & N \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$}{ &  & \\ &  & \\ &  &} \\
\hline
Liaison hélicoïdale & Torseur d'actions transmissibles & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} X & L \\ Y & M \\ Z & N \end{array}\right\}_{O}$  & \begin{tabular}{l} 1 axe $\overrightarrow{x}$ \\ $L=\frac{p.X}{2\pi}$ \end{tabular} }{ &  & \\ &  & \\ &  &} \\
\hline
\end{tabular}
\end{center}
}}
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & 0 \\ Y & M \\ Z & N \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$ }{ &  & \\ &  & \\ &  &} \\
\hline
Liaison sphérique à doigts & Torseur d'actions transmissibles & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} X & 0 \\ Y & 0 \\ Z & N \end{array}\right\}_{O}$  & 2 axes, $\overrightarrow{x},\overrightarrow{y}$  }{ &  & \\ &  & \\ &  &} \\
\hline
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & L \\ 0 & M \\ Z & 0 \end{array}\right\}_{O}$  & \begin{tabular}{l} 1 axe $\overrightarrow{z}$ \\ normale au plan \end{tabular} }{ &  & \\ &  & \\ &  &}  \\
\hline
Liaison linéaire annulaire & Torseur d'actions transmissibles & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & 0 \\ Y & 0 \\ Z & 0 \end{array}\right\}_{O}$  & 1 axe $\overrightarrow{x}$ }{ &  & \\ &  & \\ &  &}\\
\hline
Liaison linéaire rectiligne & Torseur d'actions transmissibles & Axes nécessaires \\
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & 0 \\ 0 & M \\ Z & 0 \end{array}\right\}_{O}$  & \begin{tabular}{l} 2 axes $\overrightarrow{x}$, $\overrightarrow{z}$ \\ direction de la ligne $\overrightarrow{x}$ \\ normale au plan $\overrightarrow{z}$ \end{tabular} }{ &  & \\ &  & \\ &  &} \\
\hline
\end{tabular}
\end{center}
}}
...
\ifdef{\public}{ & $\left\{ \begin{array}{cc} 0 & 0 \\ 0 & 0 \\ Z & 0 \end{array}\right\}_{O}$  & \begin{tabular}{l} 1 axe $\overrightarrow{z}$ \\ normale au plan \end{tabular} }{ &  & \\ &  & \\ &  &} \\
\hline
