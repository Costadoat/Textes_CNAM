...
\paragraph{Question 1 :} Calculez le serrage radial à 20°C. Il s'agit de la différence de rayon des éléments à assembler.

\paragraph{Question 2 :} Que devient ce serrage à température de fonctionnement (120°C )? 

Attention, ce calcul est approximatif. Il suppose une déformation nulle de l'extérieur de la pièce 2.
...
\begin{figure}[!h] 
  \centering\includegraphics[width=0.65\linewidth]{img/ab3.png}
  \caption{Tenacité/Résistance}
  \label{img:image8}
\end{figure}

\begin{figure}[!ht] 
  \centering\includegraphics[width=0.7\linewidth]{img/ab4.png}
